...
datapackage_skeleton(
  ...
  path = tempdir()) 
#> ✔ Creating '/tmp/Rtmp8nBWCK/mtcars20/'
#> ✔ Setting active project to '/tmp/Rtmp8nBWCK/mtcars20'
#> ✔ Creating 'R/'
#> ✔ Writing 'DESCRIPTION'
#> Package: mtcars20
...
#> ── R CMD build ─────────────────────────────────────────────────────────────────
#> * checking for file ‘/tmp/Rtmp8nBWCK/mtcars20/DESCRIPTION’ ... OK
#> * preparing ‘mtcars20’:
...
#> [1] "/tmp/Rtmp8nBWCK/mtcars20_1.0.tar.gz"
...
#> Installing package into '/tmp/RtmpXKy9h5/temp_libpath6ff356c15b42'
