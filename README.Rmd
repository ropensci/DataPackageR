...
> **Important Note**: [datapack](https://github.com/ropensci/datapack) is a *different pacakge* that is used to "create, send and load data from common repositories such as DataONE into the R environment".
...
See this [rOpeSci blog post](https://ropensci.org/blog/2018/09/18/datapackager/) on how to build data packages interactively using DataPackageR. 
